...
struct SettingsView: View {
                ...
                Button {
                    ...
                    HStack {
                        ...
                        if locale.language == lang {
                            Image(systemName: "checkmark").foregroundColor(.appAccent)
                        }
                    }
                }
            }
    ...
    private func websiteRow(_ title: String, _ subtitle: String, _ icon: String, _ url: String) -> some View {
        Button {
            ...
            HStack {
                Image(systemName: icon).foregroundColor(.appAccent)
    ...
    private var purchaseSection: some View {
        Section(s.t("settings_section_unlock")) {
            Button {
                ...
                HStack {
                    Image(systemName: purchase.isUnlocked ? "checkmark.seal" : "lock.open").foregroundColor(.appAccent)
                    VStack(alignment: .leading) {
    ...
    private var syncSection: some View {
        Section(s.t("settings_section_sync")) {
            Button {
                ...
                HStack {
                    Image(systemName: "icloud").foregroundColor(.appAccent)
                    VStack(alignment: .leading) {
